...
import firebase.app.com.miloficiosproy.models.Post;
...
import firebase.app.com.miloficiosproy.providers.PostProvider;
import firebase.app.com.miloficiosproy.utils.FileUtil;
import firebase.app.com.miloficiosproy.utils.ViewedMessageHelper;
...
public class PostActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(PostActivity.this, "firebase.app.com.miloficiosproy", photoFile);
