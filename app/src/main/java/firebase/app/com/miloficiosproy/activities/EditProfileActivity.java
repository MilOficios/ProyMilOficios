package firebase.app.com.miloficiosproy.activities;
...
import firebase.app.com.miloficiosproy.fragments.ProfileFragment;
import firebase.app.com.miloficiosproy.models.User;
import firebase.app.com.miloficiosproy.providers.AuthProvider;
import firebase.app.com.miloficiosproy.providers.ImageProvider;
import firebase.app.com.miloficiosproy.providers.UsersProvider;
import firebase.app.com.miloficiosproy.utils.FileUtil;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void clickEditProfile() {
        ...
        if (!mUsername.isEmpty() && !mPhone.isEmpty()) {
            if (mImageFile != null && mImageFile2 != null ) {
                //Toast.makeText(this, "ENTRO LINEA 184", Toast.LENGTH_SHORT).show();
                saveImageCoverAndProfile(mImageFile, mImageFile2);
            }
            // TOMO LAS DOS FOTOS DE LA CAMARA
            else if (mPhotoFile != null && mPhotoFile2 != null) {
                //Toast.makeText(this, "ENTRO LINEA 189", Toast.LENGTH_SHORT).show();
                saveImageCoverAndProfile(mPhotoFile, mPhotoFile2);
            }
            else if (mImageFile != null && mPhotoFile2 != null) {
                //Toast.makeText(this, "ENTRO LINEA 194", Toast.LENGTH_SHORT).show();
                saveImageCoverAndProfile(mImageFile, mPhotoFile2);
            }
            else if (mPhotoFile != null && mImageFile2 != null) {
                //Toast.makeText(this, "ENTRO LINEA 198", Toast.LENGTH_SHORT).show();
                saveImageCoverAndProfile(mPhotoFile, mImageFile2);
            }
            else if (mPhotoFile != null) {
                //Toast.makeText(this, "ENTRO LINEA 202", Toast.LENGTH_SHORT).show();
                saveImage(mPhotoFile, true);
            }
            else if (mPhotoFile2 != null) {
                //Toast.makeText(this, "ENTRO LINEA 206", Toast.LENGTH_SHORT).show();
                saveImage(mPhotoFile2, false);
            }
            else if (mImageFile != null) {
                //Toast.makeText(this, "ENTRO LINEA 210", Toast.LENGTH_SHORT).show();
                saveImage(mImageFile, true);
            }
            else if (mImageFile2 != null) {
                //Toast.makeText(this, "ENTRO LINEA 214", Toast.LENGTH_SHORT).show();
                saveImage(mImageFile2, false);
            }
            else {
                //Toast.makeText(this, "ENTRO LINEA 218", Toast.LENGTH_SHORT).show();
                User user = new User();
    ...
    private void updateInfoText(User user) {
        if (mDialog.isShowing()) {
            mDialog.show();
        }
        mUsersProvider.updateInfoText(user).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                mDialog.dismiss();
                if (task.isSuccessful()) {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(EditProfileActivity.this, "firebase.app.com.miloficiosproy", photoFile);
